...
#include <maskor_ev3_actions/AveragingAction.h>
...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<maskor_ev3_actions::AveragingAction> as_;
  std::string action_name_;
  int data_count_, goal_;
  float sum_, sum_sq_;
  maskor_ev3_actions::AveragingFeedback feedback_;
  maskor_ev3_actions::AveragingResult result_;
  ros::Subscriber sub_;
};
